...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "Computer Graphics _ Brick Breaker", nullptr/*glfwGetPrimaryMonitor()*/, nullptr);
	...
	VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("Cube.obj");
